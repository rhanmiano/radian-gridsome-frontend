        ...
        <div class="container h-full w-full pt-12 mt-12 md:mt-0">
          <div class="w-full block md:flex px-6 md:px-12">
            <div class="w-full lg:w-9/12">
              ...
              <p>If you find yourself in need of Web Development services and think that I can do the job, kindly send an email to <strong>rhanmiano29@gmail.com</strong> or connect to me via Discord <strong>(radian #9508)</strong>. Thanks!</p>
            </div>
