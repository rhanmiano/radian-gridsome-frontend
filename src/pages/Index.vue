<template>
  <!-- <NavLayout :navInfo="navInfo"> -->
    <main class="bg-brand h-screen">
      <div class="container h-full w-full md:w-6/12 lg:w-3/12 flex flex-wrap justify-center content-center">
        <div class="w-full px-2">
          ...
          <div class="font-glegoo text-layout-w1 text-center leading-tight">
            <h2 class="mb-6">{{ greet[0] }}</h2>
            <h1 class="">
              I'm <strong class="font-glegoo-bold">Rhan Miano</strong>, an aspiring <strong class="font-glegoo-bold">Web Developer</strong> from <strong class="font-glegoo-bold">Taguig, PH</strong>.
            </h1>
          </div>
